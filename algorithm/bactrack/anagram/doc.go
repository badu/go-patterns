...
// here we need to search for anagrams as well.
...
// For example we can keep the hash value as sum of ASCII values of
// all characters under modulo of a big prime number.
// For every character of text,
// we can add the current character to hash value and subtract the first character of previous window.
...
// Time Complexity
// ===========================================
// The time(worst time) complexity of this algorithm is O(n) (check?????)
//
// RUN INSTRUCTIONS 1:
// ===========================================
// func main() {
